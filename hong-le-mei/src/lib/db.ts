  ...
  private seed() {
    ...
    const seedCalendar: CalendarItem[] = [
      ...
      },
      {
        ...
        status: 'published',
        type: 'image',
        metrics: { reach: 0, likes: 0, collects: 0, comments: 0 },
      },
    ];
